...
from MSL_MayaRename.gui.RenameGUI.SuffixPrefixWidget.AutoPrefixButton import AutoPrefixButton
...
class SuffixPrefixWidget(QtWidgets.QWidget):
    ...
    def create_widgets(self):
        ...
        self.AutoPrefixButton = AutoPrefixButton()
    ...
    def create_layouts(self):
        ...
        self.main_layout.addWidget(self.AutoPrefixButton)
