...
class ButtonLibraryWidget(QtWidgets.QPushButton):
	"""
	...
	def __repr__(self):
		return f"Class: ButtonLibraryWidget - [{self.name}]"
	...
	def enterEvent(self, event):
		super(ButtonLibraryWidget, self).enterEvent(event)
		self.setCursor(QtCore.Qt.PointingHandCursor)
	
	def leaveEvent(self, event):
		super(ButtonLibraryWidget, self).leaveEvent(event)
		self.setStyleSheet(self.Style_btn)
		self.setCursor(QtCore.Qt.ArrowCursor)
	
	def mouseReleaseEvent(self, event):
		super(ButtonLibraryWidget, self).mouseReleaseEvent(event)
