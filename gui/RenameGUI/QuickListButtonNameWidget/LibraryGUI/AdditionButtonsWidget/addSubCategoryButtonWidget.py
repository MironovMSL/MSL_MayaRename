...
class addSubCategoryButtonWidget(QtWidgets.QPushButton):
	...
	def leaveEvent(self, event):
		super(addSubCategoryButtonWidget, self).leaveEvent(event)
		self.setStyleSheet(self.Style_btn)
		self.setCursor(QtCore.Qt.ArrowCursor)

	def mouseReleaseEvent(self, event):
		super(addSubCategoryButtonWidget, self).mouseReleaseEvent(event)
		self.setCursor(QtCore.Qt.PointingHandCursor)

	def mousePressEvent(self, event):
		super(addSubCategoryButtonWidget, self).mousePressEvent(event)