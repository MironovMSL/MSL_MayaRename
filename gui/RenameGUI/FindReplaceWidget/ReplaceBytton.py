...
class ReplaceBytton(QtWidgets.QPushButton):
	Style_btn = """
	    QPushButton {
	...
	def __init__(self, parent=None):
		super(ReplaceBytton, self).__init__(parent)
		
		# Module---------------------------
		self.resoures = Resources.get_instance()
		# Attribute---------------------------
		self.icon = self.resoures.get_icon_from_resources("gui-findnreplace-svgrepo-com.svg")
		tooltip = f"Replace a name of objects"
		# Setting---------------------------
	...
	def enterEvent(self, event):
		...
		super(ReplaceBytton, self).enterEvent(event)
	
	def leaveEvent(self, event):
		self.setCursor(QtCore.Qt.ArrowCursor)
		super(ReplaceBytton, self).leaveEvent(event)