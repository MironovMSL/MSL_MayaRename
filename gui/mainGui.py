...
class MainToolWindow(QtWidgets.QDialog):
	...
	def showEvent(self, e):
		...
		self.RenameGUI.SuffixPrefixWidget.AutoPrefixButton.set_script_job_enabled(True)
	...
	def closeEvent(self, e):
		...
		self.RenameGUI.SuffixPrefixWidget.AutoPrefixButton.set_script_job_enabled(False)
